...
{
    public class IncidentWorker_JunkChunkDrop : IncidentWorker
    {
        ...
        protected override bool CanFireNowSub(IncidentParms parms)
        {
            ...
            if (!Current.Game.World.factionManager.OfPlayer.ideos.HasAnyIdeoWithMeme(InternalDefOf.VME_Scrapper))
            {
                return false;
            }
        ...
        protected override bool TryExecuteWorker(IncidentParms parms)
        {
            ...
            Messages.Message("VME_MessageJunkChunkDrop".Translate(), new TargetInfo(pos, map), MessageTypeDefOf.NeutralEvent);
            return true;
        }
        ...
        {
            SkyfallerMaker.SpawnSkyfaller(ThingDefOf.ShipChunkIncoming, InternalDefOf.VME_AncientSpaceJunk, pos, map);
        }
